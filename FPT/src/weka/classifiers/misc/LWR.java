 ...
 */  
public class LWR extends AbstractClassifier   
implements OptionHandler, UpdateableClassifier,   
WeightedInstancesHandler {  

	private static final long serialVersionUID = 1460961560689771611L;
	...
	public static void main(String [] argv) {  
		...
		try {  
			System.out.println(Evaluation.evaluateModel((weka.classifiers.Classifier) new LWR(), argv));  
		} catch (Exception e) {  
